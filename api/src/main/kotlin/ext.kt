...
public inline suspend fun <reified T : Resource> ResourceRepository.get(requestQuantity: Quantity): Result<T> =
    getByType(T::class, requestQuantity)

public inline suspend fun <reified T : Resource> ResourceRepository.put(resource: T): Result<Unit> =
