...
public data class SauceIngredientsImpl private constructor(
    ...
    public class Builder {
        ...
        public fun build(): ResourceOld.SauceIngredients {
            ...
            return SauceIngredientsImpl(macronutrients!!, expiration!!)
        }
    }
    ...
    public class DslBuilder {
        ...
        public fun build(): ResourceOld.SauceIngredients {
            ...
            return SauceIngredientsImpl(macronutrients!!, ExpirationImpl(expiration!!))
        }
    }
}
